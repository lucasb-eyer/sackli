...
class AccessPattern:
  ...
  RANDOM: ClassVar[AccessPattern] = ...
  SEQUENTIAL: ClassVar[AccessPattern] = ...
  SYSTEM: ClassVar[AccessPattern] = ...
...
class CachePolicy:
  __members__: ClassVar[dict] = ...  # read-only
  DIRECT_IO: ClassVar[CachePolicy] = ...
  DROP_AFTER_READ: ClassVar[CachePolicy] = ...
  SYSTEM: ClassVar[CachePolicy] = ...
  __entries: ClassVar[dict] = ...
  def __init__(self, value: int) -> None: ...
  def __eq__(self, other: object) -> bool: ...
  def __hash__(self) -> int: ...
...
class Reader(Sequence[bytes]):
  ...
  def __len__(self) -> int: ...
  def __reversed__(self) -> ReaderIterator: ...
